...
from game import BlackjackGame, Card, Deck, Card, Deck
...
# Verifica se o jogador perde as fichas
...
# Testa a lógica de resetar o jogo
...
# Verifca compra de carta em um baralho vazio
